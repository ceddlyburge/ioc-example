...
namespace Reporting.ConsoleApplication
{
    public class ConsoleWindsorInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.Register(Classes.FromAssemblyInDirectory(new AssemblyFilter(@"D:\Source\Cedds Reporting cum IOC Proof of Concept\Reports")).BasedOn<Report>().WithServiceBase());
